...
class BannerComponent(discord.ui.LayoutView):
    def __init__(self, yume_phrase, global_banner, server_banner, footer):
        ...
        if global_banner is not None:
            components.append(discord.ui.MediaGallery(discord.MediaGalleryItem(media = global_banner)))
        ...
        if server_banner is not None:
            components.append(discord.ui.MediaGallery(discord.MediaGalleryItem(media = server_banner)))
